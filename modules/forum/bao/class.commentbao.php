...
include_once MODULES_FORUM.'dao/class.commentdao.php';
...
Class CommentBAO{
	...
	public function incrementDiscussionViews($DiscussionID){
		$Result = $this->_CommentDAO->incrementDiscussionViews($DiscussionID);
		
		if(!$Result->getIsSuccess()) {
			$Result->setResultObject("Database failure in CommentDAO.incrementDiscussionViews()");		
		}
		return $Result;
	}
